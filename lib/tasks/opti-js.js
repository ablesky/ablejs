/**
 * A grunt task that for optimize js files.
 */
...
module.exports = function(grunt) {
    ...
    grunt.registerMultiTask('optijs', 'A grunt task that for optimize js files.', function() {
        ...
        this.files.forEach(function(element, i, array) {
            ...
            (function recursiveSource() {
                ...
                if (!fs.existsSync(sourcePath)) {
                    ...
                    log.write('source js: ' + sourcePath.data + '\n');
                    log.write('result js: ' + resultPath.data + ' ...');
