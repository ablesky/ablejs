...
module.exports = function(grunt) {
    ...
    var jsmodules = require('../common/jsmodules');
    ...
    grunt.registerMultiTask('optijsp', 'A grunt task that for optimize jsp/html files.', function() {
        ...
        var gexcludes = dependency.findNested(jsBasePath, jsmodules.gid);
        gexcludes.push(jsmodules.gid);
        ...
        function filemapTemplate(modules) {
            ...
            return Object.keys(ret).length > 0 ? '<script type="text/javascript">require.config({path: ' + JSON.stringify(ret) + '});</script>' : '';
        }
        ...
        this.files.forEach(function(element, i, array) {
            ...
            (function recursiveSource() {
                ...
                if (!fs.existsSync(sourcePath)) {
                    ...
                    if (placeholderExpr.test(sourceContent)) {
                        console.log(1)
