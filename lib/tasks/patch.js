...
module.exports = function(grunt) {
    ...
    grunt.registerTask('patch', 'A grunt task that for project patch.', function() {
        ...
        function getConcatTaskConfig() {
            ...
            var cssProfile = profileUtil.getConcats('css', cssBaseDir);
            var jsProfile = profileUtil.getConcats('js', jsBaseDir);
                    ...
                    switch (i) {
                        ...
                        case ROOTDIR_JS:
                            ...
                            if (options.jshint === true) {
                                grunt.config('jshint.develop.src', changedFiles[ROOTDIR_JS].concat([]).map(function(ele) {
                                    return path.join(jsBaseDir, ele);
                                }));

                                runTasksList.push('jshint:develop');
                            }
