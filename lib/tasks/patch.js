                ...
                if (changedFiles[i].length > 0) {
                    switch (i) {
                        case ROOTDIR_IMG:
                            ...
                            break;
                        case ROOTDIR_CSS:
                            grunt.config('opticss.files.src', grunt.config('optiimg.files.src').filter(function(ele) {
                                // keep rules which no match.
                                return /^!/.test(ele);
                            ...
                            break;
                        case ROOTDIR_JS:
                            grunt.config('optijs.files.src', grunt.config('optiimg.files.src').filter(function(ele) {
                                // keep rules which no match.
                                return /^!/.test(ele);
