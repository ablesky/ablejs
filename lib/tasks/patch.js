...
module.exports = function(grunt) {
    ...
    grunt.registerTask('patch', 'task for project patch', function() {
        ...
        var patchProjectName = this.args[0]; // the project name which patch belongs to.
        var patchDir = this.args[1]; // the directory path where patch put in.
        ...
        fs.readdir(patchDir, function(err, files) {
            ...
            files.forEach(function(ele, index, array) {
                ...
                // At the current time in ablesky, all js/css/images/jsp patch files in a certain dir (eg. "js.lib" "jsp.includes").
