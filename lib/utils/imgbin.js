...
// external libs.
var pngOptiPath = require('optipng-bin').path; // https://github.com/yeoman/node-optipng-bin
var jpgTranPath = require('jpegtran-bin').path; // https://github.com/yeoman/node-jpegtran-bin
...
exports.optimize = function(sourceFile, resultFile, callback) {
    ...
    switch (fileType) {
        case 'gif':
        case 'png':
            // "optipng-bin" can't overwrite target.
            fs.existsSync(resultFile) && file.delete(resultFile);
