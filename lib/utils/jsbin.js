...
/**
 * @example jsbin.parse(fileContent)
 */
exports.isAMD = function(fileContent) {
    return detect(fileContent);
};
...
exports.optimize = function(sourcePath, resultPath, identifier, options, callback) {
    ...
    if (findNestedDependencies) {
        ...
        requirejs.optimize({
            ...
            exclude: identifier === jsmodules.gid ? [] : dependency.findNested(baseUrl, jsmodules.gid),
            include: identifier !== jsmodules.gid ? [] : jsmodules.gincludes,
            packages: [],
